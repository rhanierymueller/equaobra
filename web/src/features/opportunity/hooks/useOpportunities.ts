...
const MOCK_OPPORTUNITIES: Opportunity[] = [
  {
    ...
    contractorName: 'Carlos Mendonça',
    companyName: 'Construtora Mendonça',
    avatarInitials: 'CM',
    obraDescription:
      'Reforma completa de edifício residencial de 8 andares. Precisamos de equipe experiente para acabamento e instalações.',
    obraLocation: 'São Paulo, SP',
    lat: -23.5505,
    lng: -46.6333,
    obraStart: '2026-04-01',
    obraDuration: '60 dias',
    lookingForProfessions: ['Pedreiro', 'Eletricista', 'Pintor'],
    contactEmail: 'carlos@construtoramendonca.com.br',
  ...
  },
  {
    ...
    contractorName: 'Ana Ferreira',
    companyName: 'AF Engenharia',
    avatarInitials: 'AF',
    obraDescription:
      'Construção de galpão industrial 2.000m². Estrutura metálica já contratada, precisamos de acabamento civil.',
    obraLocation: 'Guarulhos, SP',
    lat: -23.4628,
    lng: -46.533,
    obraStart: '2026-04-15',
    obraDuration: '45 dias',
    lookingForProfessions: ['Pedreiro', 'Encanador'],
    contactEmail: 'ana@afengenharia.com',
  ...
  {
    id: 'opp-mock-3',
    contractorId: 'mock-contractor-3',
    contractorName: 'Roberto Lima',
    avatarInitials: 'RL',
    obraDescription:
      'Casa térrea nova de 180m² em condomínio fechado. Projeto aprovado, terreno preparado.',
    obraLocation: 'Campinas, SP',
    lat: -22.9071,
    lng: -47.0627,
    obraStart: '2026-05-01',
    obraDuration: '90 dias',
