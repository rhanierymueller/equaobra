...
export function ProfessionalCard({ professional: p, selected = false, compact = false, onClick }: ProfessionalCardProps) {
    ...
    >
      <div className="flex items-start gap-3">
        ...
        >
              ...
              <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                ...
                {p.available ? (
                  <span className="flex items-center gap-1">
                    ...
                    <span className="text-xs" style={{ color: '#4CAF50' }}>Disponível</span>
                  </span>
                ) : (
          ...
          {!compact && (
            <>
              <p className="text-xs mt-2 leading-relaxed line-clamp-2" style={{ color: 'rgba(245,240,235,0.5)' }}>
                {p.bio}
              </p>
              <div className="flex items-center justify-between mt-3">
                <div className="flex items-center gap-3">
                  <span className="flex items-center gap-1 text-xs" style={{ color: 'rgba(245,240,235,0.45)' }}>
