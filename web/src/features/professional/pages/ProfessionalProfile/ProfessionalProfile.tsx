      ...
      <div className="h-screen flex items-center justify-center" style={{ background: '#0D0C0B' }}>
        <div
          style={{
            width: 32,
            height: 32,
            border: '3px solid rgba(224,123,42,0.3)',
    ...
    return (
      <div className="h-screen flex items-center justify-center" style={{ background: '#0D0C0B' }}>
        <div className="text-center">
          ...
          <button onClick={() => router.push('/home')} style={{ color: '#E07B2A', fontSize: 14 }}>
            ← Voltar
          </button>
        </div>
      </div>
        ...
        <div className="py-6" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0 pt-0.5">
              <h1
                className="font-bold text-white text-xl leading-tight mb-1.5"
