      ...
      >
        <View className="flex-1 px-6 pt-20 pb-10">
          ...
          <View className="flex-row items-center justify-center mt-6 gap-1">
            <Text className="text-sm" style={{ color: 'rgba(245,240,235,0.4)' }}>Não tem conta?</Text>
            <Link href="/(auth)/register" asChild>
              <TouchableOpacity>
                <Text className="text-sm font-bold" style={{ color: PRIMARY }}>Cadastre-se</Text>
              </TouchableOpacity>
            </Link>
          </View>

          <View className="mt-4 p-3 rounded-xl items-center" style={{ backgroundColor: 'rgba(224,123,42,0.06)', borderWidth: 1, borderColor: 'rgba(224,123,42,0.15)' }}>
