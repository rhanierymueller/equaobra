...
export default function PerfilScreen() {
  ...
  const [professions, setProfessions] = useState<string[]>(
    user?.professions ?? (user?.profession ? [user.profession] : []),
  )
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        ...
        >
          ...
          >
            <Text style={{ color: colors.primary, fontFamily: fonts.extraBold, fontSize: 26 }}>
              {initials}
            </Text>
          </View>
          <Text style={{ color: colors.text.primary, fontFamily: fonts.extraBold, fontSize: 20 }}>
            {user.name}
          </Text>
          <Text style={{ color: 'rgba(245,240,235,0.4)', fontSize: 13, marginTop: 2 }}>
            {user.email}
          </Text>
          <View
            style={{
          ...
          >
            <Text style={{ color: colors.primary, fontSize: 12, fontFamily: fonts.semiBold }}>
              {isContractor ? 'Contratante' : 'Profissional'}
            </Text>
          </View>
        </View>
            ...
            <>
              ...
              >
                ...
                <InfoRow
                  ...
                  label="PROFISSÕES"
                  value={
                    (user.professions ?? (user.profession ? [user.profession] : [])).join(' • ') ||
                    undefined
                  }
                />
                <InfoRow
                  ...
                  label="VALOR/HORA"
                  value={
                    (user as any).hourlyRate ? `R$ ${(user as any).hourlyRate}/hora` : undefined
                  }
                />
                ...
                {isContractor && (
                  <InfoRow icon="business-outline" label="EMPRESA" value={user.companyName} />
                )}
                {(user as any).companyWebsite && (
                  <InfoRow
                    icon="globe-outline"
                    label="WEBSITE"
                    value={(user as any).companyWebsite}
                  />
                )}
              </View>
            ...
            <>
              ...
              {!isContractor && (
                ...
                >
                  ...
                  <Text style={{ color: 'rgba(245,240,235,0.35)', fontSize: 12, marginBottom: 12 }}>
                    ...
                    {PROFESSIONS_LIST.map((p) => (
                      <TouchableOpacity
                        ...
                        style={{
                          ...
                          borderWidth: 1,
                          borderColor: professions.includes(p)
                            ? colors.primary
              ...
              >
                ...
                <View style={{ flexDirection: 'row', gap: 10 }}>
                  ...
                  <View style={{ flex: 1 }}>
                    <Field label="UF" value={state} onChangeText={setState} placeholder="SC" />
                  </View>
                </View>
              </View>
              ...
              <View style={{ flexDirection: 'row', gap: 10, marginBottom: 16 }}>
                ...
                >
                  <Text style={{ color: 'rgba(245,240,235,0.5)', fontFamily: fonts.semiBold }}>
                    Cancelar
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
